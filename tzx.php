...
$favicon_path = 'https://lf16-tiktok-common.ibytedtos.com/obj/tiktok-web-common-sg/mtact/static/images/logo_144c91a.png?v=2';
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY) : ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="#" class="float-right text-muted">Priv8 TFM</a></div>
        <?php else : ?>
            <div class="col-12"><a href="#" class="float-right text-muted">Priv8 TFM</a></div>
        <?php endif; ?>
    </div>
</form>
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Priv8 TFM">
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'Priv8 TFM';
        $tr['en']['AppTitle']           = 'Priv8 TFM';
        $tr['en']['Login']          = 'Sign in';
